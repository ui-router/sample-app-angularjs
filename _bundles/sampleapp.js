...
var prefsFutureState = exports.prefsFutureState = {
  ...
  lazyLoad: function lazyLoad(transition) {
    var $ocLazyLoad = transition.injector().get('$ocLazyLoad');
    return new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 37)).then(function (mod) {
...
var mymessagesFutureState = exports.mymessagesFutureState = {
  ...
  lazyLoad: function lazyLoad(transition) {
    var $ocLazyLoad = transition.injector().get('$ocLazyLoad');
    return new Promise(function(resolve) { resolve(); }).then(__webpack_require__.bind(null, 38)).then(function (mod) {
...
_ngmodule.ngmodule.config(['$transitionsProvider', function ($transitionsProvider) {
  ...
  $transitionsProvider.onSuccess({}, function (trans) {
    return vpv(path(trans));
  }, { priority: -10000 });
  $transitionsProvider.onError({}, function (trans) {
    return error(trans);
  }, { priority: -10000 });
}]);
...
var _angularjs = __webpack_require__(39);
...
ngmodule.config(['$uiRouterProvider', '$locationProvider', function ($uiRouter, $locationProvider) {
