...
/***/ function(module, exports) {
	...
	function isInjectable(val) {
	    if (isArray(val) && val.length) {
	        ...
	        return !(head.filter(exports.not(isString)).length || tail_1.filter(exports.not(isFunction)).length);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Resolvable = (function () {
	    ...
	    Resolvable.makeResolvables = function (resolves) {
	        var invalid = common_1.filter(resolves, common_1.not(common_2.isInjectable)), keys = Object.keys(invalid);
	        if (keys.length)
...
/***/ function(module, exports, __webpack_require__) {
	...
	function $StateProvider($urlRouterProvider, $urlMatcherFactoryProvider) {
	    ...
	    var builder = new module_1.StateBuilder(matcher, $urlMatcherFactoryProvider);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var enterExitHooks_1 = __webpack_require__(40);
	var resolveHooks_1 = __webpack_require__(41);
	...
	function ng1UIRouter($locationProvider) {
	    ...
	    coreservices_1.services.location.onChange = function (callback) {
	        ...
	        return function deregisterListener() {
	            var idx = urlListeners.indexOf(callback);
	            if (idx !== -1)
	...
	var resolveFactory = function () { return ({
	    resolve: function (invocables, locals, parent) {
	        ...
	        var resolveData = function (parentLocals) {
	            var rewrap = function (locals) { return module_2.Resolvable.makeResolvables(common_2.map(locals, function (local) { return function () { return local; }; })); };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlRouter_2 = __webpack_require__(38);
	var transitionService_1 = __webpack_require__(39);
	var Router = (function () {
	    function Router() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlRouterProvider = (function () {
	    ...
	    UrlRouterProvider.prototype.otherwise = function (rule) {
	        ...
	        this.otherwiseFn = common_1.isString(rule) ? function () { return rule; } : rule;
	        return this;
	    };
	    ;
	    UrlRouterProvider.prototype.when = function (what, handler) {
	        var $urlMatcherFactory = this.$urlMatcherFactory;
	...
	var UrlRouter = (function () {
	    function UrlRouter(urlRouterProvider) {
	        ...
	        Object.keys(UrlRouter.prototype)
	            .filter(function (key) { return typeof UrlRouter.prototype[key] === 'function'; })
	            .forEach(function (key) { return _this[key] = _this[key].bind(_this); });
	    }
