	...
	var PathFactory = (function () {
	    ...
	    PathFactory.bindTransNodesToPath = function (resolvePath) {
	        ...
	        resolvePath.forEach(function (node) {
	            ...
	            node.resolves["$stateParams"] = new resolvable_1.default("$stateParams", function () { return node.values; }, node.state);
	        });
	        return resolvePath;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UrlMatcher = (function () {
	    function UrlMatcher(pattern, config) {
	        ...
	        var placeholder = /([:*])([\w\[\]]+)|\{([\w\[\]]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, searchPlaceholder = /([:]?)([\w\[\]-]+)|\{([\w\[\]-]+)(?:\:((?:[^{}\\]+|\\.|\{(?:[^{}\\]+|\\.)*\})+))?\}/g, last = 0, m, patterns = [];
