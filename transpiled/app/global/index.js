...
var loading_indicator_service_1 = require("./loading_indicator.service");
var requiresAuth_hook_1 = require("./requiresAuth.hook");
var globalAppModule = {
    directives: { dialog: dialog_directive_1.dialog },
    services: { AppConfig: appConfig_service_1.AppConfig, AuthService: auth_service_1.AuthService, Contacts: dataSources_service_1.Contacts, Folders: dataSources_service_1.Folders, Messages: dataSources_service_1.Messages, DialogService: dialog_service_1.DialogService, LoadingIndicatorService: loading_indicator_service_1.LoadingIndicatorService },
